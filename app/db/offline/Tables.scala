...
trait Tables {
  ...
  final case class AuthpermissionRow(id: Long, permission: String, description: Option[String] = None)
  ...
  final case class AuthroleRow(id: Long, role: String, description: Option[String] = None, isadmin: Boolean)

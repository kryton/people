...
trait Tables {
  ...
  final case class AuthpermissionRow(id: Long, permission: String)
  /** GetResult implicit for fetching AuthpermissionRow objects using plain SQL queries */
  implicit def GetResultAuthpermissionRow(implicit e0: GR[Long], e1: GR[String]): GR[AuthpermissionRow] = GR{
    prs => import prs._
    AuthpermissionRow.tupled((<<[Long], <<[String]))
  }
  ...
  class Authpermission(_tableTag: Tag) extends profile.api.Table[AuthpermissionRow](_tableTag, Some("offline"), "AuthPermission") {
    def * = (id, permission) <> (AuthpermissionRow.tupled, AuthpermissionRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(permission)).shaped.<>({r=>import r._; _1.map(_=> AuthpermissionRow.tupled((_1.get, _2.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  final case class AuthroleRow(id: Long, role: String)
  /** GetResult implicit for fetching AuthroleRow objects using plain SQL queries */
  implicit def GetResultAuthroleRow(implicit e0: GR[Long], e1: GR[String]): GR[AuthroleRow] = GR{
    prs => import prs._
    AuthroleRow.tupled((<<[Long], <<[String]))
  }
  ...
  class Authrole(_tableTag: Tag) extends profile.api.Table[AuthroleRow](_tableTag, Some("offline"), "AuthRole") {
    def * = (id, role) <> (AuthroleRow.tupled, AuthroleRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(id), Rep.Some(role)).shaped.<>({r=>import r._; _1.map(_=> AuthroleRow.tupled((_1.get, _2.get)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  final case class AuthrolepermissionRow(id: Long, permissionid: Long, roleid: Long)
   ...
   *  @param roleid Database column roleID SqlType(BIGINT) */
  final case class AuthuserRow(id: Long, username: String, roleid: Long)
  ...
  final case class BusinessunitRow(id: Long, name: String)
  ...
  final case class CorplevelRow(id: Long, level: Long, name: String, admin: Boolean, ic: Boolean = false, nonexempt: Boolean = false, archetypeid: Option[Long] = None, scope: Option[String] = None, complexity: Option[String] = None, supervision: Option[String] = None, knowledge: Option[String] = None, yearsofexperience: Option[String] = None)
  ...
  final case class CostcenterRow(costcenter: Long, costcentertext: Option[String] = None, account: Option[String] = None, functionalarea: Option[String] = None, businessunit: Option[Long] = None)
  ...
  implicit def GetResultCostcenterRow(implicit e0: GR[Long], e1: GR[Option[String]], e2: GR[Option[Long]]): GR[CostcenterRow] = GR{
    prs => import prs._
    CostcenterRow.tupled((<<[Long], <<?[String], <<?[String], <<?[String], <<?[Long]))
  }
  ...
  class Costcenter(_tableTag: Tag) extends profile.api.Table[CostcenterRow](_tableTag, Some("offline"), "CostCenter") {
    def * = (costcenter, costcentertext, account, functionalarea, businessunit) <> (CostcenterRow.tupled, CostcenterRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(costcenter), costcentertext, account, functionalarea, businessunit).shaped.<>({r=>import r._; _1.map(_=> CostcenterRow.tupled((_1.get, _2, _3, _4, _5)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  final case class EmpbioRow(login: String = "", bio: Option[String] = None, lastupdated: Option[java.sql.Date] = None)
  ...
  final case class EmphistoryRow(personnumber: Long, login: Option[String] = None, firstname: String, nickname: Option[String] = None, lastname: String, managerid: Option[String] = None, costcenter: Long, officeid: Long, employeetype: Option[String] = None, hirerehiredate: Option[java.sql.Date] = None, lastseen: Option[java.sql.Date] = None)
  ...
  final case class EmployeemilestoneRow(id: Long, milestoneid: Long, login: String, completedon: java.sql.Date, enteredon: java.sql.Date, comments: String, duration: Option[Int] = Some(0))
  ...
  final case class EmployeerosterRow(login: String, corplevelid: Long)
  ...
  final case class EmppayrollRow(login: String, crypted: String)
  ...
  final case class EmptagRow(id: Long, login: String, dateadded: java.sql.Date, tagtext: String)
  ...
  final case class GitcommitRow(sha: String, message: String, committer: Option[String] = None, author: Option[String] = None, commitdate: Option[java.sql.Date] = None, authordate: Option[java.sql.Date] = None)
  ...
  final case class GitissueRow(id: Long, issuenumber: Long, user: String, title: String, state: String, assignee: Option[String] = None, createdat: Option[java.sql.Date] = None, updatedat: Option[java.sql.Date] = None, closedat: Option[java.sql.Date] = None, pullurl: Option[String] = None)
  ...
  final case class IndividualarchetypeRow(id: Long, login: String, archetypeid: Long)
  ...
  final case class IndividualbusinessunitRow(id: Long, login: String, businessunitid: Long)
   ...
   *  @param summary Database column summary SqlType(TEXT) */
  final case class JiraparentissueRow(id: String, jirakey: String, self: String, summary: String)
   ...
   *  @param rejectedon Database column RejectedOn SqlType(DATE), Default(None)
   *  @param rejectedreason Database column RejectedReason SqlType(VARCHAR), Length(254,true), Default(None) */
  final case class KudostoRow(id: Long, fromperson: String, toperson: String, dateadded: java.sql.Date, feedback: String, rejected: Boolean, rejectedby: Option[String] = None, rejectedon: Option[java.sql.Date] = None, rejectedreason: Option[String] = None)
  ...
  final case class ManagerarchetypeRow(id: Long, name: String, minspan: Long, maxspan: Option[Long] = None, maturity: Option[String] = None, timespent: Option[String] = None, taskrepeatability: Option[String] = None, subordinatesskills: Option[String] = None)
   ...
   *  @param login Database column Login SqlType(VARCHAR), Length(254,true) */
  final case class MatrixteammemberRow(id: Long, matrixteammemberid: Long, login: String)
  ...
  final case class MilestoneRow(id: Long, order: Int, shorttext: String, longtext: String, isautomated: Boolean, starlevel: Int)
  ...
  final case class OfficeRow(id: Long, city: Option[String] = None, street: Option[String] = None, pobox: Option[String] = None, region: Option[String] = None, zipcode: Option[String] = None, country: Option[String] = None)
  ...
  final case class OkrkeyresultRow(id: Long, objectiveid: Long, dateadded: java.sql.Date, objective: String, description: Option[String] = None, score: Option[Int] = None, completed: Boolean)
  ...
  final case class OkrobjectiveRow(id: Long, login: String, dateadded: java.sql.Date, objective: String, quarterdate: Option[java.sql.Date] = None, score: Option[Int] = None, completed: Boolean, retired: Boolean = false)
  ...
  final case class PositiontypeRow(id: Long, position: String, positiontype: String = "UNKNOWN")
  ...
  final case class RatecardRow(id: Long, companyname: String)
  ...
  final case class RatecardrateRow(id: Long, roleid: Long, country: String, monthlyrate: Double, hourlyrate: Double)
  ...
  final case class RatecardroleRow(id: Long, ratecardid: Long, level: String, corplevelid: Option[Long] = None, yearsmin: Long, yearsmax: Long)
  ...
  final case class ResourcepoolRow(id: Long, poolname: String)
  ...
  final case class ResourcepoolteamRow(id: Long, poolid: Long, teamdescription: String)
  ...
  final case class ScenarioRow(id: Long, login: String, parent: Option[Long] = None, name: String, desc: Option[String] = None, managerratio: Double, spanavg: Double, employeecount: Long, offshorecount: Long, contractorcount: Long, maxlayers: Long, ispublic: Boolean = false)
   ...
   *  @param businessunit Database column businessUnit SqlType(BIGINT), Default(None)
   *  @param archetypeid Database column archeTypeID SqlType(BIGINT), Default(None) */
  final case class ScenariodetailRow(id: Long, scenario: Long, login: String, managerid: Option[String] = None, iscurrent: Boolean, iscontractor: Boolean, isoffshore: Boolean, staffnumber: Long, corplevel: Option[Long] = None, businessunit: Option[Long] = None, archetypeid: Option[Long] = None)
  ...
  final case class ScenariolevelRow(id: Long, scenario: Long, layer: Long, managercount: Long, employeecount: Long, offshorecount: Long, contractorcount: Long, spanperlayeravg: Double, spanperlayermin: Double, spanperlayermax: Double)
  ...
  final case class SurveyanswerRow(id: Long, set: Long, setinstanceperson: Long, question: Long, value: Int)
  ...
  final case class SurveycategoryRow(id: Long, set: Long, name: String, description: String, disabled: Boolean = false)
   ...
   *  @param name Database column name SqlType(VARCHAR), Length(254,true)
   *  @param disabled Database column disabled SqlType(BIT), Default(false) */
  final case class SurveyquestionRow(id: Long, category: Long, name: String, disabled: Boolean = false)
   ...
   *  @param description Database column description SqlType(TEXT)
   *  @param disabled Database column disabled SqlType(BIT), Default(false) */
  final case class SurveysetRow(id: Long, name: String, description: String, disabled: Boolean = false)
  ...
  final case class SurveysetinstanceRow(id: Long, set: Long, forperson: String, askedon: java.sql.Date, closed: Boolean = false)
  ...
  final case class SurveysetpersonRow(id: Long, personrole: Long, setinstance: Long, answeredon: java.sql.Date, frompersonanon: String)
   ...
   *  @param dateadded Database column DateAdded SqlType(DATE)
   *  @param tagtext Database column TagText SqlType(VARCHAR), Length(254,true) */
  final case class TeamdescriptionRow(id: Long, login: String, dateadded: java.sql.Date, tagtext: String)
